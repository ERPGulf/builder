...
frappe.ui.form.on("Bulk Salary Structure Assignment", {
    ...
    "base",
    "variable",
    "custom_food_allowance",
    "custom_transport_allowance",
    "custom_hra",
    "custom_special",
    "custom_mobile_allowance",
    "custom_accomodation",
    "custom_allowance",
];

        const get_editor = (colIndex, rowIndex, value, parent, column) => {
            if (!editable_columns.includes(column.name)) return;
	...
	get_employees_datatable_columns() {
		return [
            ...
            {
                name: "custom_food_allowance",
                id: "custom_food_allowance",
                content: __("Food Allowance"),
                editable: true,
            },

            {
                name: "custom_transport_allowance",
                id: "custom_transport_allowance",
                content: __("Transport Allowance"),
                editable: true,
            },
            ...
            {
                name: "custom_mobile_allowance",
                id: "custom_mobile_allowance",
                content: __("Mobile Allowance"),
                editable: true,
            },

            {
                name: "custom_accomodation",
                id: "custom_accomodation",
                content: __("Accomodation"),
                editable: true,
            },

            {
                name: "custom_allowance",
                id: "custom_allowance",
                content: __("Allowance"),
                editable: true,
            },
		].map((x) => ({
			...x,
	...
	assign_structure(frm) {
		...
		frm.checked_rows_indexes.forEach((idx) => {
			...
			rows[idx].forEach((cell) => {
                ...
                if (assignment_fields.includes(cell.column.name)) {
