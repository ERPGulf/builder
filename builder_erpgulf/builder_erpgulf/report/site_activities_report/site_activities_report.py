...
#     # ── Fetch latest Project Progress for this project ──
...
#     # ── ACTIVITIES IN PROGRESS ──
#     # From Project Progress child table: activities_in_progress
#     rows.append({"section": "INPROGRESS_HEADER"})
...
#     # From Project Progress child table: activities_planned_for_the_next_day
#     rows.append({"section": "NEXTDAY_HEADER"})
